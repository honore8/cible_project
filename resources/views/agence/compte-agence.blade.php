                ...
                <div class="col mb-3">
                    <div class="card pr-2 pl-2" style="background-color: #d1e2fc;">
                        ...
                        <div class="d-flex justify-content-center">
                            <button class=" mb-2 btn _btn_blue btn_blue" ><a class="test btn_blue" data-toggle="modal" data-target="#selectionModal" >Selectionner</a></button>
                            <button class=" mb-2 btn _btn_blue ml-2 btn_blue" data-toggle="modal" data-target="#vendreModal"> <a href="{{url('info')}}" class="test btn_blue">Plus d'info</a> </button>
                        </div>
                    </div>
                </div>
                <div class="col mb-3">
                    <div class="card pr-2 pl-2" style="background-color: #d1e2fc;">
                        ...
                        <div class="d-flex justify-content-center">
                            <button class=" mb-2 btn _btn_blue btn_blue" ><a class="test btn_blue" data-toggle="modal" data-target="#selectionModal" >Selectionner</a></button>
                            <button class=" mb-2 btn _btn_blue ml-2 btn_blue" data-toggle="modal" data-target="#vendreModal"> <a href="" class="test btn_blue">Plus d'info</a> </button>
                        </div>
                    </div>
                </div>
                <div class="col mb-3">
