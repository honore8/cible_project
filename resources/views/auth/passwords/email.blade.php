                ...
                <div class="p-5">
                  ...
                  @csrf
                    <div class="form-group">
                      <input type="email" id="email"  style="border-radius: 20px" class="form-control  form-control-user @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Addresse Email...">
                      @error('email')
