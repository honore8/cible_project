...
<h3 class="text-center mt-4">Completer votre profil</h3>
     <div class="formulaire d-flex justify-content-center">
      ...
      <form method="post" action="<?php echo e(route('savePersonne'); ?>}">  
        <?php echo csrf_field(); ?>
<div class="row mt-5 container">
  ...
  <div class="col-md-5 offset-md-1">
    ...
    <input type="email" name="email" style="border-radius: 20px" class="form-control connex" value="<?php echo e(Auth::user(}->email); ?> readonly">
  </div>
  <div class="col-md-5 ml-xl-5 offset-md-1">
...
<?php echo $__env->make('organisateurs.model-organisateurs-account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\cible_project\resources\views/organisateurs/profile-individu.blade.php ENDPATH**/ ?>