...
<br>
<div class="container-fluid" style="margin-left: 93px;margin-top: 5%">
  <div class="row justify-content-end " >
    <nav aria-label="Page navigation example" class="col-4 text-center">
      <ul class="pagination d-block " style="position:absolute;margin-left: 364px ; margin-top: 40%">
        <li class="page-item">
        </li>
        <li class="page-item" style="width: 3%;"><a class="page-link" href="#section1" style="text-align:center">1</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section2">2</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section3">3</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section4">4</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section5">5</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section6">6</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section7">7</a></li>
        <li class="page-item" style="width: 3%"><a class="page-link" href="#section8">8</a></li>
        <li class="page-item" style="width: 3%">
        </li>
      </ul>
    </nav>
    </div>
...
<?php echo $__env->make('organisateurs.model-organisateurs-account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\cible_project\resources\views/organisateurs/evenement-organisateurs.blade.php ENDPATH**/ ?>