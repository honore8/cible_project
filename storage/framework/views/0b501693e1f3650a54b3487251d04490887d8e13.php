...
<h4 class="text-center my-5 __about propos"> <strong>  A PROPOS DE NOUS </strong></h4>
      <div class="container mt-5">
        <p>Créée en novembre 2019 par des anciens boursiers d’excellence, la société KP10 IS a pour dessein parmi tant d’autres de contribuer au développement du monde éducatif. Elle propose les différents services tels qu’en :
                          ...
                          <div class="functioning" id="headingOne">
                              <h2 class="mb-0">
                                  <div class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <span class="h5"> Statistiques et Big Data </span>
                                  </div>
                              </h2>
                          </div>
                          ...
                          <div class="functioning" id="headingTwo">
                              <h2 class="mb-0">
                                  <div class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                      <span class="h5">Développement Informatique</span>
                                  </div>
                              </h2>
                          </div>
                          ...
                          <div class="functioning" id="headingThree">
                              <h2 class="mb-0">
                                  <div class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                      <span class="h5">Infographie et design</span>
                                  </div>
                              </h2>
                          </div>
                      ...
                      <div class="mb-2">
                        <div class="functioning" id="headingFour">
                            <h2 class="mb-0">
                                <div class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
                                    <span class="h5">Maintenance Informatique</span>
                                </div>
                            </h2>
                        </div>
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    ...
                    <p>
                        ...
                        <p>
                        Avez-vous besoin des solutions informatiques ou statistiques ? N’hésitez pas à nous contacter au +228 910 159 80/+228 910 161 47 ou de visiter notre site internet <a href="<?php echo e(url('https://kp10is.com/index.php')); ?>">www.kp10is.com</a>. 
                        </p>
                  </div>
      </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\cible_project\resources\views/Apropos.blade.php ENDPATH**/ ?>